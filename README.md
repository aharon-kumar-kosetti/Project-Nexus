...
- Role customization beyond admin/user
- Cloud object storage for uploads

## Author

Built as **Project Nexus** (Stark·Webb Command) portfolio work.

If you want, I can also generate a compact one-page portfolio case-study version of this README for recruiters.